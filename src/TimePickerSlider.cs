...
namespace RoyT.TimePicker
{
    ...
    public class TimePickerSlider : Control
    {
        ...
        public static readonly DependencyProperty TimeProperty =
            DependencyProperty.Register("Time", typeof(DigitalTime), typeof(TimePickerSlider), new PropertyMetadata(new DigitalTime(12, 0), new PropertyChangedCallback(TimeChanged)));
        ...
        public static readonly DependencyProperty MinTimeProperty =
            DependencyProperty.Register("MinTime", typeof(DigitalTime), typeof(TimePickerSlider), new PropertyMetadata(new DigitalTime(9, 0), new PropertyChangedCallback(TimeChanged)));
        ...
        public static readonly DependencyProperty MaxTimeProperty =
            DependencyProperty.Register("MaxTime", typeof(DigitalTime), typeof(TimePickerSlider), new PropertyMetadata(new DigitalTime(21, 0), new PropertyChangedCallback(TimeChanged)));
